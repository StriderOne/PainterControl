...
class PainterControl():
    ...
    def __init__(self, ip, home_position, speed, acceleration, verbose = False):
        ...
        rotation_matrix = Rotation.from_rotvec(np.array([1.897, -0.037, -0.019])).as_matrix()
        ...
        self.canvas_tf = np.array([
            [rotation_matrix[0][0], rotation_matrix[0][1],  rotation_matrix[0][2], 0.253],
            [rotation_matrix[1][0], rotation_matrix[1][1],  rotation_matrix[1][2], -0.467],
            [rotation_matrix[2][0], rotation_matrix[2][1],  rotation_matrix[2][2], 0.607],
            [0.0,        0.0,        0.0,      1.0]
        ])
